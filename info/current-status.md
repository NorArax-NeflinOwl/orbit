...
| Live updates over a WebSocket (chat, notifications, presence) | Implemented on the web client; the phone still polls | [Functionality — Live updates](functionality.md#live-updates) |
