...
| **5. The rest of chat** (group conversations, editing and deleting built) | Group chat (send-time fan-out, §5.5), roles, edit/delete, read receipts, forwarding, contacts | Chat parity |
