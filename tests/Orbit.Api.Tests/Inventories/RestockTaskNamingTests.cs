...
/// <summary>
/// What the restock list and its entries are called. Two paths write these - an inventory item going low
...
{
    [Fact]
    public void The_list_says_which_inventory_it_restocks()
    {
        // Three inventories used to mean three lists called the same thing.
        Assert.Equal("Restock supplies - Pantry", RestockTaskNaming.TitleFor("Pantry"));
    }

    [Fact]
    public void A_inventory_with_no_name_leaves_the_title_as_it_was()
    {
