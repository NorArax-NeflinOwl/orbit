...
/// <summary>
/// What an incoming inventory row says its amounts are counted in. The rule the whole feature is
...
/// refused.
/// </summary>
public sealed class InventoryItemUnitMappingTests
{
    [Fact]
    ...
    public void A_row_that_says_nothing_is_counted_in_pieces(string? unit)
    {
        ...
        // Refusing it left such a client unable to save an inventory at all, with a message about a
    ...
    private static InventoryItemRequest Item(string? unit)
        => new(
