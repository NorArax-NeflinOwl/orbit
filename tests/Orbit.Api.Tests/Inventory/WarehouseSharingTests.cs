...
public sealed class WarehouseSharingTests
{
    ...
    public async Task A_can_edit_recipient_cannot_delete_the_warehouse()
    {
        ...
        var handler = new DeleteWarehouseCommandHandler(context.WarehouseRepository, context.InventoryRepository, new InMemorySyncTombstoneRepository());
    ...
    public async Task A_deleted_warehouse_disappears_for_its_share_recipients_too()
    {
        ...
        await new DeleteWarehouseCommandHandler(context.WarehouseRepository, context.InventoryRepository, new InMemorySyncTombstoneRepository())
