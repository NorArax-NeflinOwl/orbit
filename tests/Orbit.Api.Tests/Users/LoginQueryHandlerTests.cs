...
{
    [Fact]
    public async Task HandleAsync_returns_the_user_for_correct_credentials()
    {
        var passwordHasher = new PasswordHasher();
        var repository = new InMemoryUserRepository();
        var user = User.Create("login@example.com", "Login User", passwordHasher.Hash("correct-password"));
    ...
    public async Task HandleAsync_returns_null_for_a_wrong_password()
    {
        ...
        await repository.AddAsync(
            User.Create("login@example.com", "Login User", passwordHasher.Hash("correct-password")), CancellationToken.None);
        var handler = new LoginQueryHandler(repository, passwordHasher);
    ...
    [Fact]
    public async Task HandleAsync_returns_null_for_an_unknown_email()
    {
