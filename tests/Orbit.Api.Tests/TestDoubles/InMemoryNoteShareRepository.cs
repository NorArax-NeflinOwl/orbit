...
internal sealed class InMemoryNoteShareRepository : INoteShareRepository
{
    ...
    public Task<IReadOnlyList<NoteShare>> GetSharesToAsync(Guid ownerUserId, Guid recipientUserId, CancellationToken cancellationToken)
    {
        IReadOnlyList<NoteShare> shares = _shares
