...
public sealed class DeleteNoteCommandHandlerTests
{
    ...
    public async Task HandleAsync_deletes_a_note_owned_by_the_requesting_user()
    {
        ...
        var handler = new DeleteNoteCommandHandler(repository, new InMemoryNoteShareRepository(), new InMemorySyncTombstoneRepository(), new InMemoryNotePictureRepository(), new InMemoryNotePictureStore());
    ...
    {
        var handler = new DeleteNoteCommandHandler(new InMemoryNoteRepository(), new InMemoryNoteShareRepository(), new InMemorySyncTombstoneRepository(), new InMemoryNotePictureRepository(), new InMemoryNotePictureStore());
    ...
    public async Task A_note_somebody_shared_with_you_comes_off_your_list_without_touching_theirs()
    {
        ...
        var handler = new DeleteNoteCommandHandler(noteRepository, shareRepository, new InMemorySyncTombstoneRepository(), new InMemoryNotePictureRepository(), new InMemoryNotePictureStore());
    ...
    public async Task A_note_nobody_shared_with_you_is_still_a_404()
    {
        ...
        var handler = new DeleteNoteCommandHandler(noteRepository, new InMemoryNoteShareRepository(), new InMemorySyncTombstoneRepository(), new InMemoryNotePictureRepository(), new InMemoryNotePictureStore());
