...
public sealed class GoogleSignInTests
{
    ...
    /// <summary>Stands in for the system browser, which is the one part of this that needs a device.</summary>
    private sealed class FakeSignInBrowser : IWebSignInBrowser
    {
        public static readonly Uri Address = new("com.orbitmaui.android:/oauth2redirect");

        public Uri CallbackAddress => Address;
