...
/// <summary>
/// That every command the avatar's menu binds to actually exists.
///
...
public sealed class AvatarMenuBindingTests
{
    ...
    {
        var commands = Regex.Matches(ReadTheMenu(), @"Binding (\w+Command)\}")
    ...
    /// </summary>
    private static string ReadTheMenu()
    {
        ...
        return File.ReadAllText(Path.Combine(
            directory!.FullName, "src", "Clients", "Orbit.Maui", "Controls", "AvatarMenu.xaml"));
    }
}
