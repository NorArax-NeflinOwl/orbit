...
/// </summary>
public sealed class InventorySummaryTests : OrbitTestContext
{
    ...
    public InventorySummaryTests()
    {
                ...
                : new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = request.RequestUri!.AbsolutePath.EndsWith("/items", StringComparison.Ordinal)
                ...
                : JsonContent.Create(new InventoryDto(
    ...
    public void The_row_a_link_pointed_at_is_marked()
    {
        ...
        Services.GetRequiredService<NavigationManager>()
            .NavigateTo($"https://example.test/inventory/{InventoryId}?highlight={FirstBatchId}");
        var cut = RenderComponent<InventorySummary>(parameters => parameters.Add(page => page.InventoryId, InventoryId));
