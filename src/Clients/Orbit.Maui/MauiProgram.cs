...
public static class MauiProgram
{
	...
	private static void RegisterLocalStore(IServiceCollection services)
	{
		...
		// One instance, because it is where the reader has been rather than what a screen knows: the
		...
		// somebody is typing - see SoftKeyboardState, and MainActivity's insets listener, which is what sets
		// it on Android.
		services.AddSingleton<SoftKeyboardState>();
