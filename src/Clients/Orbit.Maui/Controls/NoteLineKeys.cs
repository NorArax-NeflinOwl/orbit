...
/// arrives, and given the field it came from as its parameter. The property lives here rather than
/// beside it because the page that sets it is shared by both heads, and code compiled for iOS cannot
...
///
/// Set it in the markup, not in code once the field has loaded: the Android half decides whether to
/// listen for the key while the field's handler is being built, which is earlier than that, and a field
