...
/// <summary>
/// The places this account keeps - see Orbit.Core.Places.Place. Nothing is sealed here and nothing is
/// shared yet, so this is the plainest client in the app: what the server holds is what comes back.
/// </summary>
