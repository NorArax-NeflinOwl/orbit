...
internal static class PolishTranslations
{
    public static readonly IReadOnlyDictionary<string, string> ByEnglish = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Parts of Orbit this account can use. Each is unlocked separately, with a code entered under Debug."] = "Części Orbita, z których to konto może korzystać. Każdą odblokowuje się osobno, kodem wpisanym w zakładce Debug.",
        ["In Orbit"] = "W Orbicie",
