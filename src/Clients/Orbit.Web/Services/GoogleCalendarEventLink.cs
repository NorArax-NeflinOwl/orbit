...
/// </summary>
/// <param name="Title">
/// Orbit's own title, newlines and all - the editor's one control makes the first line the name and the
/// rest the description, and a pasted name can hold more than one line either way. Google's title is a
