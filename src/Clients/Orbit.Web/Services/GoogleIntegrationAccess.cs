...
public sealed class GoogleIntegrationAccess
{
    ...
    public GoogleIntegrationAccess(UsersApiClient usersApiClient, ILogger<GoogleIntegrationAccess> logger)
    {
    ...
    /// <summary>
    /// False when the account qualifies for neither route, and false when the account can't be read at
    /// all - a page that can't tell should offer nothing rather than offer something that may not work.
    /// </summary>
