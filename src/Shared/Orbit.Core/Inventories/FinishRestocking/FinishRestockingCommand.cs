...
namespace Orbit.Core.Inventories.FinishRestocking;

/// <summary>
/// "Everything on this list is done": crosses off what is left of a restock list and brings its whole
/// inventory up to the levels it is meant to hold. Returns how many shelf items that moved - zero for a
/// list no inventory tracks, which is every ordinary list.
/// </summary>
