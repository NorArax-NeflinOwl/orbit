...
/// <summary>
/// Puts one appointment away, or brings it back - see CalendarEvent.Archive, and
/// Orbit.Core.Folders.BuiltInFolder.Archived, which is the tab it gathers under while it is away.
///
/// Its own command rather than a field on the update, for the reason MoveCalendarEventToFolderCommand is its
...
public sealed record ArchiveCalendarEventCommand(Guid UserId, Guid CalendarEventId, bool IsArchived) : IRequest<bool>;
