...
public static class OrbitCoreServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddOrbitCore(this IServiceCollection services)
    {
        ...
        services.AddScoped<IRequestHandler<GetNotePictureQuery, NotePictureContent?>, GetNotePictureQueryHandler>();
        services.AddScoped<IRequestHandler<DeleteNotePictureCommand, bool>, DeleteNotePictureCommandHandler>();
        services.AddScoped<IRequestHandler<GetPublicSharedPictureQuery, NotePictureContent?>, GetPublicSharedPictureQueryHandler>();
